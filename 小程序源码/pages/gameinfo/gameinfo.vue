<template>
	<view class="content">
		...
		<image class="images" :src="imageUrl"></image>
		<view class="tag">
			{{tag}}
		</view>
		<view class="gameIntro">游戏简介</view>
		...
		<view class="buttonBox">
			<button class="gain" @tap="toGain">成就</button>
			<button class="discount">折扣</button>
			<button class="subscribe" @tap="onSub">{{subContent}}</button>
		</view>
