<template>
	<view class="content">
		...
		<view class="inv-h-w">
			...
			<view :class="['inv-h',Inv==2?'inv-h-se' :'']" @click="getComments" >
				评论
			</view>
		</view>
		...
		<view class="page1" v-show="Inv==1">
			...
			<view class="uni-form-item holdButton ">
							...
							<image class="goodImg" src="../../static/good.png" mode=""  v-show="good==0"  @tap="good==1">
							</image>
							<image class="goodImg" src="../../static/comments.png" mode="" >
							</image>
			...
			<view class="uni-list">
				...
				@tap="opengameinfo" :data-gameid="item.gameId">
					<view class="uni-media-list">
						<image class="uni-media-list-logo commentImg" :src="item.userImage">
						</image>
